...
export const testmanan1_get_Pet_id_read = id => ({
  type: types.TESTMANAN1_GET__PET_ID_READ,
  id
})
export const testmanan1_get_Pet_id_readSucceeded = response => ({
  type: types.TESTMANAN1_GET__PET_ID_READ_SUCCEEDED,
  response
})
export const testmanan1_get_Pet_id_readFailed = error => ({
  type: types.TESTMANAN1_GET__PET_ID_READ_FAILED,
  error
})
